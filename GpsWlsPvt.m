...
gpsPvt.pseudo_delays   = zeros(N,size(gnssMeas.PrM, 2));
pseudo_delays = gpsPvt.pseudo_delays;
...
for i=1:N
    ...
    y = i;
    [xHat,~,~,H,Wpr,Wrr,pseudo_delays] = WlsPvt(prs,gpsEph,xo,pseudo_delays,y,iValid);%compute WLS solution
    xo = xo + xHat;
  
    gpsPvt.pseudo_delays = pseudo_delays;
